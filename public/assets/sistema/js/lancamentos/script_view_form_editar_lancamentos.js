...
function saveDadosLancamento() {
    ...
    $.ajax({
        ...
        success : function(data){
            ...
            document.getElementById('tituloPagina').innerHTML = '('+document.getElementById('inputFornecedor').options[document.getElementById('inputFornecedor').selectedIndex].text+')'
            ...
            if(data['status']) {
                Swal.fire({
                    ...
                    didClose: (toast) => {
                        ...
                        window.location.href = `../../lancamentos/detalhes/${document.getElementById('inputId').value}`
                    }
                });
            }
